  ...
  return (
    <div className="py-2">
      <h2>
        ...
        >
          <div>
            <p className="text-2xl tracking-normal">{title}</p>
            <p className="text-base text-(--pink-500) tracking-normal">{company}</p>
            <p className="text-base tracking-normal">{dates}</p>
          </div>
